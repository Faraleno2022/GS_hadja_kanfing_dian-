...
def ajouter_nature_frais_si_absente(apps, schema_editor):
    """Crée la colonne sur les deux historiques de migrations fusionnés."""
    ...
    champ.set_attributes_from_name("nature_frais")
    champ.model = Echeancier
    schema_editor.add_field(Echeancier, champ)
        ...
        migrations.SeparateDatabaseAndState(
            database_operations=[
                migrations.RunPython(
                    ajouter_nature_frais_si_absente,
