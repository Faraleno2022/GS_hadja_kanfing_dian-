...
urlpatterns = [
    ...
    path('logistique/articles/', views_logistique.ancienne_logistique_redirection, name='liste_articles'),
    path('logistique/articles/nouveau/', views_logistique.ancienne_logistique_redirection, name='creer_article'),
    path('logistique/articles/<int:article_id>/', views_logistique.ancienne_logistique_redirection, name='detail_article'),
    path('logistique/articles/<int:article_id>/modifier/', views_logistique.ancienne_logistique_redirection, name='modifier_article'),
    path('logistique/articles/<int:article_id>/supprimer/', views_logistique.ancienne_logistique_redirection, name='supprimer_article'),
    ...
    path('logistique/mouvements/', views_logistique.ancienne_logistique_redirection, name='liste_mouvements'),
    path('logistique/mouvements/nouveau/', views_logistique.ancienne_logistique_redirection, name='creer_mouvement'),
    ...
    path('logistique/export/excel/', views_logistique.ancienne_logistique_redirection, name='export_stock_excel'),
