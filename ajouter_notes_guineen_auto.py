"""
Script automatique pour ajouter des notes selon le système guinéen
Notes mensuelles (Octobre à Mai) + Compositions (Trimestre 1, 2, 3)
"""
...
print("\n" + "="*70)
print("AJOUT AUTOMATIQUE DE NOTES - SYSTÈME GUINÉEN")
print("="*70)
...
mois_trimestre1 = ['OCTOBRE', 'NOVEMBRE', 'DECEMBRE']
periode_trimestre1 = 'TRIMESTRE_1'
...
for classe in classes:
    ...
    notes_existantes = CompositionNote.objects.filter(
        matiere__classe=classe,
        periode=periode_trimestre1,
...
if classes_traitees > 0:
    ...
    print("="*70)
    print("\n📝 Notes ajoutées:")
    print("   - Notes mensuelles: Octobre, Novembre, Décembre")
    print("   - Composition: Trimestre 1")
    print("\n📝 Accès rapides:")
    print("   Bulletins: http://127.0.0.1:8000/notes/bulletin-guineen/")
    print("   Saisie: http://127.0.0.1:8000/notes/saisie-notes-guineen/")
else:
    print("\n" + "="*70)
