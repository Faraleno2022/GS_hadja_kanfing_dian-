...
urlpatterns = [
    ...
    path('enseignant/classe/<int:classe_id>/suivi/', enseignants.suivi_bonus, name='enseignant_suivi_bonus'),
    path('enseignant/classe/<int:classe_id>/presence/', enseignants.presence_classe, name='enseignant_presence'),
