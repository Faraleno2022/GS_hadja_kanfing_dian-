...
def trouver_classe_eleve(classe_note):
    """Trouve sans ambiguïté la classe Élèves liée à une classe Notes.

    L'établissement est toujours imposé. Une classe contenant des élèves actifs
    ...
    # 2. Même nom normalisé dans une année contenant les élèves actuels.
    for classe in memes_noms:
