...
urlpatterns = [
    ...
    path('grilles/', views.grilles_bus, name='grilles'),
    path('grilles/nouvelle/', views.grille_bus_form, name='grille_nouvelle'),
    path('grilles/<int:grille_id>/modifier/', views.grille_bus_form, name='grille_modifier'),
    path('grilles/<int:grille_id>/basculer/', views.basculer_grille_bus, name='grille_basculer'),
    path('api/tarif/', views.tarif_bus_json, name='tarif_bus_json'),
    ...
    path('cantine/<int:abo_id>/carte/pdf/', views_cantine.carte_cantine_pdf, name='carte_cantine_pdf'),
    path('cantine/cartes/pdf/', views_cantine.cartes_cantine_planche_pdf, name='cartes_cantine_planche_pdf'),
