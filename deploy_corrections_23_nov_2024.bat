@echo off
REM Script de déploiement des corrections du 23 novembre 2024
REM Corrections: ClasseEleve + Bulletins PDF Format Uniforme
...
REM Ajouter tous les fichiers modifiés et créés
echo 📝 Ajout des fichiers modifiés et créés...

REM Nouveaux fichiers créés aujourd'hui
...
REM Fichiers modifiés aujourd'hui
git add notes/views.py
git add templates/notes/bulletin_dynamique_single.html

REM Fichiers des moyennes mensuelles (si pas encore ajoutés)
