...
urlpatterns = [
    ...
    path(
        'enseignants/classes-affectables/',
        views.classes_affectables_enseignant,
        name='classes_affectables_enseignant',
    ),
    ...
    path('etats/export/excel/', views.export_etats_salaire_excel, name='export_etats_salaire_excel'),
